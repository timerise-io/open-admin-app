...
import { useDeleteServiceOnceStrategy } from "features/services/hooks/useDeleteServiceOnceStrategy";
...
export const OnceStrategyDeleteModal = ({ strategy, open, onClose }: StrategyDeleteModalProps) => {
  const { mutation } = useDeleteServiceOnceStrategy();
      ...
      <BaseModal open={open} customWidth={600}>
        <BaseModalUpperContentWrapper>
          ...
          <BaseModalControlsWrapper>
            ...
            <OnceStrategySummary strategy={strategy} />
            <CancelBookingsInfo />
          </BaseModalControlsWrapper>
        </BaseModalUpperContentWrapper>
