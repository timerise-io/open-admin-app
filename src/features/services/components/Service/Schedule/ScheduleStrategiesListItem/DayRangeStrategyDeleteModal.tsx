...
import { useDeleteServiceDayRangeStrategy } from "features/services/hooks/useDeleteServiceDayRangeStrategy";
...
export const DayRangeStrategyDeleteModal = ({ strategy, open, onClose }: StrategyDeleteModalProps) => {
  const { mutation } = useDeleteServiceDayRangeStrategy();
      ...
      <BaseModal open={open} customWidth={600}>
        <BaseModalUpperContentWrapper>
          ...
          <BaseModalControlsWrapper>
            ...
            <DayRangeStrategySummary strategy={strategy} />
            <CancelBookingsInfo />
          </BaseModalControlsWrapper>
        </BaseModalUpperContentWrapper>
