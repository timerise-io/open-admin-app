...
import { useDeleteServiceSlotsStrategy } from "features/services/hooks/useDeleteServiceSlotsStrateg";
...
const StrategyDeleteModal = ({ strategy, open, onClose }: StrategyDeleteModalProps) => {
  const { mutation } = useDeleteServiceSlotsStrategy();
